...
export const DEVICE_TYPES: DeviceType[] = [
  ...
  { code: 'door_strike', legend: 'Door Strike', cable: '6core_security', category: 'Security System' },
  { code: 'mag_lock', legend: 'Mag Lock', cable: '6core_security', category: 'Security System' },
  ...
  { code: 'siren_piezo', legend: 'Piezo Siren', cable: '6core_security', category: 'Security System' },
