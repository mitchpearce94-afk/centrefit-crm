 ...
 * With ?proposal=1 the quote is wrapped in the full Centrefit project
 * proposal (company pages + quote as one document).
 *
...
export async function GET(
  ...
  const asProposal = req.nextUrl.searchParams.get("proposal") === "1";
